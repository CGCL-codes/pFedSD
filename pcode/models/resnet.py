...
if __name__ == "__main__":
    ...
    p1 = copy.deepcopy(net1.state_dict())
    p2 = copy.deepcopy(net2.state_dict())
    p3 = copy.deepcopy(net3.state_dict())

    for name in net3.state_dict():
        net3.state_dict()[name][0] = (net1.state_dict()[name][0] + net2.state_dict()[name][0]) / 2

    _p1 = copy.deepcopy(net1.state_dict())
    _p2 = copy.deepcopy(net2.state_dict())
    _p3 = copy.deepcopy(net3.state_dict())
