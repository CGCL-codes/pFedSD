...
class MNIST(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None,
        ...
        self.traindata, self.traintargets = torch.load(os.path.join(self.processed_folder, self.training_file))
        self.testdata, self.testtargets = torch.load(os.path.join(self.processed_folder, self.test_file))

        self.data = torch.cat([self.traindata, self.testdata])
        self.targets = torch.cat([self.traintargets, self.testtargets])
